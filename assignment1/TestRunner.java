...
// // current user admin
// private static SchoolAdmin currentUserAdmin = new SchoolAdmin(null, null,
// null, null, 0L, 0, null, null);
...
// SchoolAdmin testSchoolAdmin = new SchoolAdmin("TestSchoolAdmin",
// "TestPassword", "TestFullName", "TestEmail",
// 12345L, 123,
// "TestPosition", school);
...
// // check if the school is added, and if the school admin is added to the
// school
// if (schoolHELP.getSchools().contains(school) &&
// school.getSchoolAdmins().contains(testSchoolAdmin)) {
...
// TutorialRequest tutorialRequest = new TutorialRequest(12345, now,
// "TestStatus", "TestDescription", 1212, 12, 1,
// 290, school);

// ResourceRequest resourceRequestTest = new ResourceRequest(12345, now,
// "TestStatus", "TestDescription",
// "TestType",
// 12, school);
...
// Volunteer volunteer = new Volunteer("TestVolunteer", "TestPassword",
// "TestFullName", "TestEmail",
// (long) 12345123122L,
// 123,
// "TestPosition");
...
// // TESTCASE4: Allowing a Volunteer usersession to view requests that have
// been
// // submitted
// /**
...
// Volunteer volunteer = new Volunteer("TestVolunteer", "TestPassword",
// "TestFullName", "TestEmail", 12345123122L,
// 123,
// "TestPosition");
// schoolHELP.addUser(volunteer);

// // check if the volunteer is added to the user list, and if the request is
// added
// // to the school
// if (schoolHELP.getUsers().contains(volunteer)
...
// Volunteer volunteer = new Volunteer("TestVolunteer", "TestPassword",
// "TestFullName", "TestEmail", 1234123125L,
// 123,
// "TestPosition");
// schoolHELP.addUser(volunteer);
// LocalDateTime offerNowTime = LocalDateTime.now();
// Offer offer = new Offer(offerNowTime, "testRemarks", "testStatus",
// volunteer);
...
// Volunteer volunteer = new Volunteer("TestVolunteer", "TestPassword",
// "TestFullName", "TestEmail", 12342131325L,
// 123,
// "TestPosition");
// schoolHELP.addUser(volunteer);
