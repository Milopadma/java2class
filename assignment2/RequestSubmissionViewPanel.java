...
// // a close relative of MultifieldInputPanel but sharded to its own class as
// it has its own slight differences
// // .. this class can be combined with MultifieldInputPanel by deriving
// an abstract class from both of them and just using that
// public class RequestSubmissionViewPanel extends JPanel {

// private JPanel text_field_panel = new JPanel();

// public RequestSubmissionViewPanel(String[] input_labels, Runnable[]
// button_functions) {
// // if the input_label is equals to DESCRIPTION, it will be the largest text
// area
// // else it will be a normal text field, all labels will be on the top left
// side
// // of the textfields
...
// done_button
// .addActionListener(e ->
// MainView.saveMultifieldTextFields(getSavedfieldNames(),
// getSavedfieldValues()));
...
// 1).limit(text_field_panel.getComponentCount()).forEach(i -> {
...
// savedfieldValues[i] = ((JTextField)
// text_field_panel.getComponent(i)).getText();
// }
// });
